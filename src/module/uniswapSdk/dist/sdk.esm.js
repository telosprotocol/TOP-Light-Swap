...
var ChainId
console.log('1111111111111111111111222')
;(function(ChainId) {
  ...
  ChainId[(ChainId['TOPEVM'] = parseInt(process.env.REACT_APP_CHAIN_ID || 0))] = 'TOPEVM'
})(ChainId || (ChainId = {}))
...
var FACTORY_ADDRESS = process.env.REACT_APP_FACTORY || ''
var INIT_CODE_HASH = process.env.REACT_APP_HASH || ''
...
console.log('1231231', process.env.REACT_APP_WETH || '')
var WETH =
  ((_WETH = {}),
  ...
  (_WETH[ChainId.TOPEVM] = /*#__PURE__*/ new Token(
    ChainId.TOPEVM,
    process.env.REACT_APP_WETH || '',
    18,
    'WETH',
    'Wrapped Ether'
  )),
